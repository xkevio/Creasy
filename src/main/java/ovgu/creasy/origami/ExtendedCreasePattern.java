...
public class ExtendedCreasePattern {
    ...
    public Set<List> getListOfVertices() { return Collections.unmodifiableSet(xL); }
    ...
    public ExtendedCreasePattern buildExtendedGraph(CreasePattern cp) {
        ...
        Set<List> xL = createList(vertices);
        ...
        for (ReflectionGraph reflectionGraph : reflectionGraphs) {
            ...
            Collection<ReflectionPath> A = ReflectionGraphFactory.getLocalMaxima(reflectionGraph);
            // global maximum in A
    ...
    // TODO
    private Set<List> createList(Set<Vertex> vertices) {
